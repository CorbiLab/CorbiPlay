...
export default function LoginPage() {
  if (!isSupabaseConfigured()) {
    // DEMO MODE: proxy.ts already skips auth entirely — no login is possible
    // or necessary. Send straight to the dashboard rather than show a dead form.
    redirect("/dashboard");
  }
      ...
      <div className="relative w-full max-w-sm space-y-8">
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <div className="space-y-1">
            <h1 className="text-2xl font-semibold tracking-tight">Hockey Trace</h1>
            <p className="text-sm text-muted-foreground">Connecte-toi à ton club</p>
          </div>
        </div>
